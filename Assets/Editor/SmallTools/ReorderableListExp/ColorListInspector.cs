using SmallTools.ReorderableListExp;
using UnityEditor;
using UnityEditorInternal;
using UnityEngine;

namespace Editor.SmallTools.ReorderableListExp
{
    [CustomEditor(typeof(ColorList))]
    public class ColorListInspector : UnityEditor.Editor
    {
        private ReorderableList m_colors;

        private void OnEnable()
        {
            m_colors = new ReorderableList(serializedObject,
